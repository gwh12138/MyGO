...
def change_field(field_id, field_name=None, size=None, crop_class=None,
                 latitude=None, longitude=None, N=None, P=None, K=None, pH=None, length=None, width=None) -> bool or None:
    """
...
def search_field(field_id=None, field_name=None, size=None, crop_class=None,
                 latitude=None, longitude=None, N=None, P=None, K=None, pH=None, length=None, width=None) -> list or None:
    """
